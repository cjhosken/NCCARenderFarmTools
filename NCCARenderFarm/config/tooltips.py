...
ACTION_PROJECT_SUBMIT_TOOLTIP="Submit a project to the folder."
ACTION_SUBMIT_RENDER_JOB_TOOLTIP="Submit a render job."
ACTION_OPEN_TOOLTIP="Open the file."
ACTION_DOWNLOAD_TOOLTIP="Download the file/folder."
ACTION_RENAME_TOOLTIP="Rename the file/folder."
