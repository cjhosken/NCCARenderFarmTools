# Submit Tooltips
NCCA_SUBMIT_PROJECTNAME_TOOLTIP = "This is the name of the project as it will appear on the Qube GUI."
...
NCCA_SUBMIT_SUBMIT_TOOLTIP = "Submit job to the farm."


# Maya Submit Tooltips
NCCA_MAYASUBMIT_RENDERER_TOOLTIP = "The active renderer on the farm."
NCCA_MAYASUBMIT_CAMERA_TOOLTIP = "The camera used for rendering on the farm."
NCCA_MAYASUBMIT_OUTPUT_TOOLTIP = "The file name in which rendered frames will be saved as."
