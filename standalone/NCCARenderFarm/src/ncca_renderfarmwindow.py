...
from gui.ncca_qfarmbrowser import NCCA_Renderfarm_QFarmBrowser
...
class NCCA_RenderFarmWindow(NCCA_QMainWindow):
    ...
    def initUI(self):
        ...
        self.launch_qube_button = NCCA_QIconButton('./src/assets/icons/cube.svg', APP_ICON_SIZE)
        ...
        self.open_settings_button = NCCA_QIconButton('./src/assets/icons/settings.svg', APP_ICON_SIZE)
        ...
        self.open_info_button = NCCA_QIconButton('./src/assets/icons/info.svg', APP_ICON_SIZE)
        ...
        # Add exit button to the navigation bar
        self.report_bug_button = NCCA_QIconButton('./src/assets/icons/bug.svg', APP_ICON_SIZE)
        ...
        self.browser = NCCA_Renderfarm_QFarmBrowser("/home/cjhosken", self, QSize(APP_PAGE_SIZE.width(), APP_PAGE_SIZE.height() - APP_NAVBAR_HEIGHT))
